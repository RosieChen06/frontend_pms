...
const MissingParcel = () => {
    ...
    const findRecord = async() => {
        ...
        setSelectedWeeknum(dayRecord[0].weeknum)
        setDayDetail({
            id: dayRecord[0]._id,
        ...
        let weekRecord = await onlineData.filter((item)=>(
            item.name === riderName && item.weeknum === selectedWeeknum
        ))
    ...
    const submitChange = async() => {
        try{
            ...
            riderId, riderWeekId, is_garantee, sp2_1_is_servicce_bonus, sp2_2_is_servicce_bonus, sp2_3_is_servicce_bonus, is_online_bonus
        ...
        <div className='flex flex-row gap-8 justify-between'>
            <div className='flex flex-row gap-8'>
                <div className='flex flex-col gap-2'>
                    <p>日期</p>
                    <input className='w-full border-gray-300 py-1 pl-2 rounded-md border-2' type='text' onChange={e=>setDate(e.target.value)}></input>
                </div>
                <div className='flex flex-col gap-2'>
                    <p>騎手姓名</p>
                    <input className='w-full border-gray-300 py-1 pl-2 rounded-md border-2' type='text' onChange={e=>setRiderName(e.target.value)}></input>
                </div>
                <div className='flex flex-col gap-2'>
                    <p>包裹編號</p>
                    <input className='w-full border-gray-300 py-1 pl-2 rounded-md border-2' type='text' onChange={e=>setParcelId(e.target.value)}></input>
                </div>
            </div>
            <div className='flex gap-4'>
                <button className='bg-green-600 h-full text-white w-36 rounded-md' onClick={()=>addItem()}>Add</button>
                <button className='bg-red-600 h-full text-white w-36 rounded-md'>Remove</button>
            </div>
        </div>
        {!dayDetail?'':
            <div className='flex flex-col gap-x-24 gap-y-8 w-full mt-8'>
                ...
                <div>
                    <div className='flex flex-row w-full bg-slate-50 rounded-md items-center justify-start'>
                        ...
                        <div className='flex flex-col w-full gap-3 p-4 hover:bg-[#004e76] hover:text-white'>
                            ...
                            <select className=' border-gray-300 py-1 rounded-md border-2 hover:text-black' type='text' value={dayDetail.is_garantee} onChange={(e)=>adjustQualification(e.target.value, "is_garantee", item._id)}>
                        ...
                        <div className='flex flex-col w-full gap-3 p-4 hover:bg-[#004e76] hover:text-white'>
                            ...
                            <select className=' border-gray-300 py-1 rounded-md border-2 hover:text-black' type='text' value={dayDetail.sp2_1_is_servicce_bonus} onChange={(e)=>adjustQualification(e.target.value, "sp2_1_service_bonus", item._id)}>
                                <option value='達標'>達標</option>
                                <option value='未達標'>未達標</option>
                                <option value='-'>-</option>
                            </select>
                        ...
                        <div className='flex flex-col w-full gap-3 p-4 hover:bg-[#004e76] hover:text-white'>
                            ...
                            <select className=' border-gray-300 py-1 rounded-md border-2 hover:text-black' type='text' value={dayDetail.sp2_2_is_servicce_bonus} onChange={(e)=>adjustQualification(e.target.value, "sp2_2_service_bonus", item._id)}>
                                <option value='達標'>達標</option>
                                <option value='未達標'>未達標</option>
                                <option value='-'>-</option>
                            </select>
                        ...
                        <div className='flex flex-col w-full gap-3 p-4 hover:bg-[#004e76] hover:text-white'>
                            ...
                            <select className=' border-gray-300 py-1 rounded-md border-2 hover:text-black' type='text' value={dayDetail.sp2_3_is_servicce_bonus} onChange={(e)=>adjustQualification(e.target.value, "sp2_3_service_bonus", item._id)}>
                                <option value='達標'>達標</option>
                                <option value='未達標'>未達標</option>
                                <option value='-'>-</option>
                            </select>
                ...
                <div>
                    ...
                    <div className='w-full flex flex-row justify-center items-center bg-slate-50 mt-8'>   
                        ...
                        <div className='flex flex-col w-full gap-3 p-4 hover:bg-[#004e76] hover:text-white'>
                            ...
                            <select className=' border-gray-300 py-1 pl-1 rounded-md border-2 hover:text-black' type='text' value={weekDetail.is_online_bonus} onChange={e=>setRiderWeekData(prev =>({...prev, is_online_bonus: e.target.value}))}>
                                <option value='達標'>達標</option>
                                <option value='未達標'>未達標</option>
                            </select>
                        </div>
                ...
                <button className='bg-pink-100 p-4' onClick={()=>submitChange()}>submit</button>
            </div>
        }
    </div>
  )
